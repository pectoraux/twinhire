...
const PROVIDERS = [
  ...
  },
  {
    ...
    desc: "Local LLMs — Llama, Mistral, Qwen",
    placeholder: "http://localhost:11434 (Ollama endpoint URL)",
  ...
  },
  {
    key: "azure_openai",
    name: "Azure OpenAI",
    desc: "Enterprise OpenAI via Azure",
  ...
  },
  {
    key: "aws_bedrock",
    name: "AWS Bedrock",
    desc: "Claude, Llama, Titan on AWS",
  ...
  },
  {
    ...
    desc: "Gemini, PaLM on GCP",
    placeholder: "... your Vertex AI key or service account JSON",
