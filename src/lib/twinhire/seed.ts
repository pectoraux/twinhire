  ...
  return [
    {
      ...
      confidence: 78,
      expectedRoi: 92,
      customerImpact: "Reduces trial-to-paid friction; improves first-week experience",
  ...
  return [
    {
      ...
      confidence: 84,
      expectedRoi: 90,
      customerImpact: "Recovers margin and improves carrier satisfaction",
      strategicImportance: 5,
      risk: 3,
    },
    {
  ...
  return [
    {
      ...
      confidence: 80,
      expectedRoi: 91,
      customerImpact: "Doubles net new paying accounts",
      strategicImportance: 5,
      risk: 3,
    },
    {
  ...
  return [
    {
      ...
      confidence: 79,
      expectedRoi: 89,
      customerImpact: "Recovers stockout sales and improves availability",
      strategicImportance: 5,
      risk: 4,
    },
    {
...
const CANDIDATE: Omit<CandidateView, "id"> = {
  ...
  profile: {
    ...
    reasoningStyle: "First-principles — decomposes problems before proposing solutions",
    learningSpeed: "Fast — adapts within a single session, visible improvement across sessions",
    goals: "Build and own operational intelligence systems at a growth-stage company",
    aiTools: ["Claude", "GPT-4", "Cursor", "n8n", "custom agents"],
    codingAbility: 4,
    writingAbility: 4,
    researchAbility: 3,
    certifications: ["AWS Solutions Architect", "dbt Analytics Engineering"],
    education: "B.Sc. Computer Science",
    domainExpertise: ["SaaS operations", "Growth analytics", "Process automation"],
  },
  reputation: 58,
  sessionsCompleted: 2,
}
